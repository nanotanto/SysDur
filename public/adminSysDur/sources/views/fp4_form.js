						...
						/*wjet::Settings*/
						{
							...
							"cols": [
								{ "autoheight": false, "view": "form", "id": 1610522963044, "elementsConfig": { "required": true, "labelPosition": "top" },
									"rows": [
										{ "label": "User ID", "view": "text", "id": 1610522963258, "name": "user_id", "labelWidth": 200, hidden:true },
										...
										{ "label": "Change Status", "options": "demo->5fd1ae8024ab08001840fc3a", "view": "select", "name": "status" },
										{ "label": "Result Analysis", "view": "textarea" },
										{ "label": "SysDur PIC", "options": "demo->5fd1ae8024ab08001840fc3a", "view": "select", "name": "admin_id" },
										{ "label": "Date", "value": "2021-01-13 14:29:23", "view": "datepicker", "name": "date_end" },
										{ "view": "button", "css": "webix_primary", "label": "Save", "id": 1610522963047 }
									],
									"type": "form",
									"borderless": 1,
									"scroll": "y"
